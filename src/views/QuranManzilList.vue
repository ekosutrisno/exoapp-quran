...
<div class="min-h-screen bg-gray-200 nv-transition">
  ...
  <section class="w-full min-w-min bg-gray-900 py-6 relative">
      <div class="max-w-7xl mx-auto p-4 relative">
         ...
         <div class="text-center">
               ...
               <h1 class="text-3xl md:text-5xl font-semibold my-4 text-gray-100">Manzil</h1>
               <p class="font-semibold text-gray-100 md:text-lg text-center">Terdapat Total <span class="font-semibold text-indigo-400">7</span> Manzil</p>
  ...
  <section class="min-w-min bg-quran pt-20">
     ...
     <div v-else class="max-w-7xl mx-auto px-4 pb-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
         <QuranManzilCard v-for="manzil in manzils" :key="manzil.number" :manzil="manzil" data-aos="fade-up" data-aos-anchor-placement="top-bottom"/>
     </div>
...
import QuranManzilCard from '../components/QuranManzilCard.vue';
import { auth } from '../service/firebase';
export default {
  components: {  Spinner, QuranManzilCard },
   setup(){
      ...
      const state = reactive({
         ...
         manzils: computed(()=> store.state.manzil.manzil),
